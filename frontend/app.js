...
const LOCAL_BACKEND_URL = window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1"
  ? "http://127.0.0.1:8000"
  : ""; // Use backend API routes relative to current host in production
const API_BASE = LOCAL_BACKEND_URL;
                  ...
                  <div className="lg:col-span-2">
                    {previewFile ? (
                      <div className="glass-panel p-6 rounded-2xl space-y-4 animate-fade-in border-accent-sky">
                        ...
                        <div className="w-full bg-dark-900 rounded-xl overflow-hidden shadow-2xl border border-white/5" style={{ height: "650px" }}>
